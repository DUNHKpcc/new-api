...
const AuthenticatedResourceDownloadsIndexRoute =
  AuthenticatedResourceDownloadsIndexRouteImport.update({
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/resource-downloads/': {
      id: '/_authenticated/resource-downloads/'
      path: '/resource-downloads'
      fullPath: '/resource-downloads/'
