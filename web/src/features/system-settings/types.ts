...
export type AuthSettings = {
  ...
  WeChatRegistrationVerificationEnabled: boolean
...
export type ContentSettings = {
  ...
  'console_setting.global_notifications': string
  ...
  'console_setting.global_notifications_enabled': boolean
