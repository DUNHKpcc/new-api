...
const BILLING_SECTIONS = [
  ...
  },
  {
    ...
    build: (settings: BillingSettings) => (
      <AffiliateSettingsSection defaultValue={settings.AffiliateSetting} />
    ),
  },
  {
    id: 'currency',
    ...
    build: (settings: BillingSettings) => (
      <PricingSection
        defaultValues={{
          ...
          SubscriptionDisplayModels: settings.SubscriptionDisplayModels,
          general_setting: {
    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          EpayCurrency: settings['payment_setting.epay_currency'] ?? 'CNY',
