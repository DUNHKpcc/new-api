...
export function PasskeyDomainSelector(props: PasskeyDomainSelectorProps) {
  // Security dialogs can be rendered by standalone consumers (and during
  // recovery/error states) without the app-level QueryClientProvider. Keep
  // the optional selector inert there instead of throwing from useQuery.
  const queryClient = useContext(QueryClientContext)
  if (!queryClient) return null

  return <PasskeyDomainSelectorWithQuery {...props} />
}

function PasskeyDomainSelectorWithQuery(props: PasskeyDomainSelectorProps) {
