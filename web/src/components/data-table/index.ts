...
export const DISABLED_ROW_DESKTOP =
  '[--data-table-card-bg:var(--table-disabled)] [--data-table-row-bg:var(--table-disabled)] hover:[--data-table-card-bg:var(--table-disabled-hover)] hover:[--data-table-row-bg:var(--table-disabled-hover)] data-[state=selected]:![--data-table-card-bg:var(--table-disabled)] data-[state=selected]:![--data-table-row-bg:var(--table-disabled)] data-[state=selected]:hover:![--data-table-card-bg:var(--table-disabled-hover)] data-[state=selected]:hover:![--data-table-row-bg:var(--table-disabled-hover)] [background-color:var(--table-disabled)] hover:[background-color:var(--table-disabled-hover)] [&>td:first-child]:[border-left-color:var(--table-disabled-border)] [&>td:first-child]:border-l-4 [&>td:first-child]:pl-1'

export const DISABLED_ROW_MOBILE =
  '[--data-table-card-bg:var(--table-disabled)] [--data-table-row-bg:var(--table-disabled)] data-[state=selected]:![--data-table-card-bg:var(--table-disabled)] data-[state=selected]:![--data-table-row-bg:var(--table-disabled)] [background-color:var(--table-disabled)]'
