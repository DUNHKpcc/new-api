...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  ...
  '/resource-downloads': { section: 'console', module: 'resource' },
  ...
  '/revenue/overview': { section: 'admin', module: 'revenue' },
  '/revenue/platform-orders': { section: 'admin', module: 'revenue' },
  '/revenue/external': { section: 'admin', module: 'revenue' },
