...
func GetOptions(c *gin.Context) {
	...
	for k, v := range common.OptionMap {
		if k == "theme.frontend" || strings.HasPrefix(k, "migration.") ||
			k == "billing_setting.billing_mode" || k == "billing_setting.billing_expr" {
			continue
		}
...
func UpdateOption(c *gin.Context) {
	...
	case "console_setting.global_notifications":
		err = console_setting.ValidateConsoleSettings(option.Value.(string), "GlobalNotifications")
		if err != nil {
